...
const Attendance = (props) => {
        ...
        (async () => {
            ...
            if (data.message === 'success') {
                ...
                if (formikRef.current && data.classes[0])
                    formikRef.current.setFieldValue('studentClass', data.classes[0]._id)
            } else {
    ...
    const updateAttendance = (value, id) => {
        ...
        let index = data.findIndex(ele => ele._id === id);
            ...
            >
                {({values, isSubmitting, errors, touched, handleChange}) => (
                    <Form className='dashboard__form'>
                        ...
                        {
                            formFeedback.msg ?
                                <h3 className={'formFeedback ' + formFeedback.type}>{formFeedback.msg}</h3> : null
                        }
...
const TableItem = (props) => {
    ...
    let presentName = 'present' + props.index;
    let absentName = 'absent' + props.index;
